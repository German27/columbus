    ...
    <div class="row">
      ...
      <form class="form perfil-form clearfix" action="" method="post" id="registrationForm" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <div class="col-xs-12">
              <br>
              <button class="btn btn-danger float-left" type="reset" id="" hidden>Descartar</button>
              <button class="btn btn-success float-right" type="submit" id="" hidden>Guardar cambios</button>
            </div>
          </div>
        </form>
